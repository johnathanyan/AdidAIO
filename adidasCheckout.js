...
function enter(){
	document.getElementsByName("dwfrm_payment_creditCard_number")[0].value = number;
	document.getElementsByName("dwfrm_payment_creditCard_cvn")[0].value = cvv;
	document.getElementsByClassName("selectoption")[parseInt(month) + 1].click()
	document.getElementsByClassName("selectoption")[28 + parseInt(yr )- 2015 + 1].click()
	document.getElementById("dwfrm_payment_creditCard_year")[0].value = (year - 2015 + 1);
	...
	*/
	document.getElementsByClassName("button-primary bp-grad light-back co-btn_primary btn-regular-red place-order")[0].click();
	document.getElementsByClassName("button-primary bp-grad light-back co-btn_primary btn-regular-red place-order")[0].click();
	document.getElementsByClassName("button-primary bp-grad light-back co-btn_primary btn-regular-red place-order")[0].click();
}
